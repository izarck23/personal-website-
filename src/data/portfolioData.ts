import { Project, ProcessStep, ServiceItem, Testimonial, FAQItem, BlogPost, MonetizationProduct, ProfileConfig } from '../types';
...
export const monetizationProductsData: MonetizationProduct[] = [
  {
